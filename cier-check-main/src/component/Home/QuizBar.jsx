...
export default function QuizBar() {
  ...
  return (
    <div className={`w-full flex flex-col items-center justify-center text-center gap-6 py-12 lg:py-20 horizontal-padding  ${theme === "light" ? 'bg-white text-black' : 'bg-dark'}`} >
      <div className={`w-full flex flex-col gap-6  p-8 rounded ${theme === "light" ? 'bg-pink-200 text-black' : 'bg-dark'} `}>
        <h2 className='text-center section-heading' >Not sure which routine is right for you? Take our skin quiz!</h2>
        <div className='mt-7' >
