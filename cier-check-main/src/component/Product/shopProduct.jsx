...
export default function ShopProduct() {
  const { theme,setDrawOpen,isDrawOpen } = useContext(ThemeContext)
  ...
  return (
    ...
    <div className='w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 mt-10 gap-6 mt-10'>
        {
        ProductsJson.map((item,i)=>(
          ...
          <div className='border border-[#FBCFE8]' key={i} >
             ...
             <div className='text-center mt-2 p-1' >
                   ...
                   <button onClick={() => HandleCart(item?.id)} className='bg-pink-600 px-5 py-3 rounded-lg border-2 border-pink-600 text-white hover:text-pink-600 hover:bg-white duration-300 transition-all mt-2 mb-4  '>Add To Cart</button>
