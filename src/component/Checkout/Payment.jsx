...
const Payment = () => {
  ...
  return (
    <div
      className={`py-10 ${
        theme === "light" ? "bg-pink-200 text-black" : "bg-[#1c1c1c]"
      }`}
    >
      <form
        onSubmit={formik.handleSubmit}
        className={`flex flex-col py-10 px-6 mx-4 ${
          theme === "light" ? "bg-pink-200 text-black" : "bg-[#2d2d2d] "
        }`}
      >
        <h1
          className={`text-3xl lg:text-5xl font-bold  px-6 py-9 ${
            theme === "light"
        ...
        <div
          className={` lex flex-col py-10 rounded-lg  ${
            theme === "light"
              ? "bg-white text-black"
        ...
        >
          <div className="w-full flex flex-col items-center justify-center py-3   text-center ">
            ...
            <p>
              ...
              <span className="text-lg lg:text-xl text-center font-bold">
                Credit card
              </span>
            </p>
          </div>
          ...
          <div className=" px-6 py-6 gap-2 flex flex-col">
            <label htmlFor="optional" className="text-xl font-semibold">
            ...
            {formik.errors.optional ? (
              <div className="text-red-600">{formik.errors.optional}</div>
            ) : null}
          </div>
          <div className=" px-6 py-6 gap-2 flex flex-col">
          ...
          <div className="w-full grid grid-cols-1 lg:grid-cols-4   gap-9 px-6 py-6  ">
            <div className=" w-full lg:col-span-2 flex flex-col gap-2">
              ...
              <input
                ...
                className="w-full px-4 py-3 border border-pink-600 outline-none text-black"
              />
            ...
            <div className="flex flex-col gap-2">
              ...
              >
                {country.map((item, index) => {
                  return <option className="py-32 text-black">{item}</option>;
                })}
              </select>
              {formik.errors.state ? (
            ...
            <div className="flex flex-col gap-2">
              <label htmlFor="zip" className="text-xl font-semibold">
                Zip Code
              </label>
              <input
                type="text"
        ...
        <div className="mt-8">
          <button
            type="submit"
            className="py-4 px-20 rounded-full text-2xl font-semibold text-white  bg-pink-600"
