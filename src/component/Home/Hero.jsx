...
const Hero = () => {
  ...
  return (
    ...
    <main className="w-full  grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 justify-center ">
      ...
      <div>
        <img src="/a0c909613b.jpeg" className=" w-full " alt="" />
      </div>
      <div className="hero w-full p-10 md:p-12 lg:p-16  flex flex-col gap-5  text-white">
        <motion.h2
          className="w-full text-2xl lg:text-2xl xl:text-5xl font-bold xl:leading-[50px]"
          ref={ref}
          initial={{ opacity: 0, y: 50 }}
          animate={{ opacity: inView ? 1 : 0, y: inView ? 0 : 50 }}
          transition={{ duration: 1, ease: "easeOut" }}
        >
         Contribute to Early Cancer Detection
        </motion.h2>
        <motion.p
